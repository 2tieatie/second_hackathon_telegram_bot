...
#     # await functions.add_user(0, 'qwe', 'admin', 'admin', 'admin', 'admin')
#     # await functions.add_user(0, 'qwe', 'admin', 'admin_1', 'admin', 'admin')
#     #
...
loop.run_until_complete(functions.db2_test())
